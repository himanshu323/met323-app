...
class HomePage extends BasePage_1.BasePage {
    ...
    loginToTrade(email, password) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield console.log(c);
            let el = yield protractor_1.element(protractor_1.by.xpath("//form[@id='searchForm']//mat-select[@name='commodity']//div[@class='mat-select-arrow-wrapper']"));
            yield protractor_1.browser.executeScript("arguments[0].click()", el);
